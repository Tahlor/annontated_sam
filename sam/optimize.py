...
def optimize_parameter(model, param_name, f, g, bounds=(1e-4, None), disp=0, max_evals=100):
    ...
    #fmin_tnc = Minimize a function with variables subject to bounds, using gradient information in a truncated Newton algorithm. This method wraps a C implementation of the algorithm.
